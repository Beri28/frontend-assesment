  ...
  return (
    <div className="h-16 p-4 py-7 pb-[2.25em] bg-[#0D0D0F] flex items-center justify-between border-b border-[#27272A] sticky top-0 z-50">
      ...
      <div className="flex items-center space-x-10">
        ...
        {/* Deposit Button */}
        <button className="flex items-center px-4 py-2 bg-[#7C3AED] hover:bg-[#6D28D9] transition-all duration-200 rounded-xl text-black text-sm font-semibold hover:scale-105 active:scale-95">
